...
/*
 ...
 question_id: ObjectId("1"),
        responses: [
          {
            answer_id: ObjectId("1"),
          },
  question_id: ObjectId("2"),
        responses: [
          {
            answer_id: ObjectId("2"),
          },
  question_id: ObjectId("3"),
        responses: [
          {
            answer_id: ObjectId("3"),
          },
  question_id: ObjectId("4"),
        responses: [
          {
            answer_id: ObjectId("4),
          },
  question_id: ObjectId("5"),
        responses: [
          {
            answer_id: ObjectId("5"),
          },
  question_id: ObjectId("6"),
        responses: [
          {
            answer_id: ObjectId("6"),
          },
  question_id: ObjectId("7"),
        responses: [
          {
            answer_id: ObjectId("7"),
          },
  question_id: ObjectId("8"),
        responses: [
          {
            answer_id: ObjectId("8"),
          },
  question_id: ObjectId("9"),
        responses: [
          {
            answer_id: ObjectId("9"),
          },
  question_id: ObjectId("10"),
        responses: [
          {
            answer_id: ObjectId("10"),
          },
        ],
